...
class JdbcXaSinkFunctionState {
	...
	static JdbcXaSinkFunctionState of(Collection<CheckpointAndXid> prepared, Collection<Xid> hanging) {
	...
	private JdbcXaSinkFunctionState(Collection<CheckpointAndXid> prepared, Collection<Xid> hanging) {
		this.prepared = prepared;
		this.hanging = hanging;
	}

	/**
	 * @return immutable collection of prepared XA transactions to {@link javax.transaction.xa.XAResource#commit commit}.
	 */
	...
	/**
	 * @return immutable collection of XA transactions to {@link javax.transaction.xa.XAResource#rollback rollback} (if they were prepared)
	 * or {@link javax.transaction.xa.XAResource#end end} (if they were only started).
	 */

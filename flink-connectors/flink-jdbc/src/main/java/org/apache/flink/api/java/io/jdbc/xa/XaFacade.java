...
/**
 * Facade to the XA operations relevant to {@link org.apache.flink.streaming.api.functions.sink.SinkFunction sink}.
 * <p>Typical workflow:
 * <ol>
 * <li>{@link #open}</li>
 * <li>{@link #start} transaction</li>
 * <li>{@link #getConnection}, write some data</li>
 * <li>{@link #endAndPrepare} (or {@link #failOrRollback})</li>
 * <li>{@link #commit} / {@link #rollback}
 * <li>{@link #close}</li>
 * </ol>
 * {@link #recover} can be used to get abandoned prepared transactions for cleanup.</p>
 */
@Internal
public interface XaFacade extends JdbcConnectionProvider, Serializable, AutoCloseable {
	 ...
	 */
	static XaFacade fromXaDataSourceSupplier(Supplier<XADataSource> dataSourceSupplier, Optional<Integer> timeoutSec) {
	 ...
	 * @param ignoreUnknown whether to ignore {@link javax.transaction.xa.XAException#XAER_NOTA XAER_NOTA} error.
	 */
	...
	/**
	 * End transaction as {@link javax.transaction.xa.XAResource#TMFAIL failed}; in case of error, try to roll it back.
	 */
	...
	/**
	 * Thrown by {@link XaFacade} when RM responds with {@link  javax.transaction.xa.XAResource#XA_RDONLY XA_RDONLY}
	 * indicating that the transaction doesn't include any changes.
	 * When such a transaction is committed RM may return an error (usually, {@link  javax.transaction.xa.XAException#XAER_NOTA XAER_NOTA}).
	 */
	...
	/**
	 * Indicates a transient or unknown failure from the resource manager (see {@link XAException#XA_RBTRANSIENT XA_RBTRANSIENT},  {@link XAException#XAER_RMFAIL XAER_RMFAIL}).
	 */

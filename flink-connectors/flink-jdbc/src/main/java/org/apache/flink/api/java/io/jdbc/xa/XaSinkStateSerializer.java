...
final class XaSinkStateSerializer extends TypeSerializer<JdbcXaSinkFunctionState> {
	...
	private static final TypeSerializerSnapshot<JdbcXaSinkFunctionState> SNAPSHOT = new SimpleTypeSerializerSnapshot<JdbcXaSinkFunctionState>(XaSinkStateSerializer::new) {

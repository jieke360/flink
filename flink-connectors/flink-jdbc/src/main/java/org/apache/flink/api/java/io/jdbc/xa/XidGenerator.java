...
public interface XidGenerator extends Serializable, AutoCloseable {
	 ...
	 * <ul>
	 *    <li>MUST be unique across Flink job, and probably across Xids generated by other jobs and applications - depends on the usage of this class</li>
	 *    <li>SHOULD be immutable</li>
	 *    <li>SHOULD override {@link Object#hashCode hashCode} and {@link Object#equals equals}</li>
	 * </ul>.
	 *
	 ...
	 * </ol>
	 * Each created {@link XidGenerator} instance MUST be used for only one Sink instance (otherwise Xids could collide).
	 */
